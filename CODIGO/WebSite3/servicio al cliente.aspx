<%@ Page Language="C#" AutoEventWireup="true" CodeFile="servicio al cliente.aspx.cs" Inherits="servicio_al_cliente" %>
...
<body>
    <!-- Header -->
    <header id="header">
        <a href="index.html" class="logo"><strong>Servicio al Cliente</strong> Banca en Linea</a>
        <nav>
            <a href="#menu">Menu</a>
        </nav>
    </header>
