<%@ Page Language="C#" AutoEventWireup="true" CodeFile="añadirProductos.aspx.cs" Inherits="añadirProductos" %>
...
<body>
    ...
    <!-- Header -->
    <header id="header">
        <a href="index.html" class="logo"><strong>Añadir Productos</strong> Banca en Linea</a>
        <nav>
            <a href="#menu">Menu</a>
        </nav>
    </header>
    ...
    <section id="main">
        <div class="inner">
            ...
            <header>
                ...
                <div>
                    <ul class="actions">
                        <li>PUNTOS:<asp:TextBox ID="TextBox2" runat="server" Width="523px"></asp:TextBox>
                        </li>
                    </ul>
                </div>
                ...
                <div>
                    <ul class="actions">
                        <li></li>
                            <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Añadir Producto" Width="944px" />
                    </ul>
                </div>
