<%@ Page Language="C#" AutoEventWireup="true" CodeFile="añadirProveedores.aspx.cs" Inherits="añadirProveedores" %>

<!DOCTYPE html>

<html lang="en" xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title>Añadir Proveedores</title>
    <meta charset="utf-8" />
...
<body>
    ...
    <!-- Header -->
    <header id="header">
        <a href="index.html" class="logo"><strong>Añadir Proveedores</strong> Banca en Linea</a>
        <nav>
            <a href="#menu">Menu</a>
        </nav>
    </header>
        ...
        <div class="inner">
            ...
            <header>
                ...
                <div>
                    <ul class="actions">
                        <li></li>
                        <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Añadir Proveedor" Width="944px" />
                    </ul>
                </div>
