<%@ Page Language="C#" AutoEventWireup="true" CodeFile="transaccionesPropias.aspx.cs" Inherits="transaccionesPropias" %>

<!DOCTYPE html>

<html lang="en" xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title>Transacciones Propias</title>
    <meta charset="utf-8" />
...
<body>
    ...
    <!-- Header -->
    <header id="header">
        <a href="index.html" class="logo"><strong>Transacciones Propias</strong> Banca en Linea</a>
        <nav>
            <a href="#menu">Menu</a>
        </nav>
    </header>
    ...
    <section id="main">
        <div class="inner">
            ...
            <header>
                ...
                <div>
                    <ul class="actions">
                        <li>CLIENTE:<asp:TextBox ID="TextBox4" runat="server" Width="523px"></asp:TextBox>
                        </li>
                    </ul>
                </div>
                ...
                <div>
                    <ul class="actions">
                        <li>&nbsp;<asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Realizar Transaccion" Width="974px" />
                        </li>
                    </ul>
                </div>
