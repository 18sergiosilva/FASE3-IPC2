<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cajero.aspx.cs" Inherits="cajero" %>
...
<body>
    <!-- Header -->
    <header id="header">
        <a href="index.html" class="logo"><strong>Cajero</strong> Banca en Linea</a>
        <nav>
            <a href="#menu">Menu</a>
        </nav>
    </header>
    ...
    <section id="main">
        <div class="inner">
            ...
            <header>
                ...
                <div>
                    <ul class="actions">
                        <li><a href="#" class="button">Retiro</a></li>
                    </ul>
                </div>

                <div>
                    <ul class="actions">
                        <li><a href="#" class="button">Deposito</a></li>
                    </ul>
                </div>

                <div>
                    <ul class="actions">
                        <li><a href="#" class="button">Cambio de Cheque</a></li>
                    </ul>
                </div>
