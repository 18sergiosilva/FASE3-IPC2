<%@ Page Language="C#" AutoEventWireup="true" CodeFile="pagoSalarios.aspx.cs" Inherits="pagoSalarios" %>
...
<body>
    ...
    <!-- Header -->
    <header id="header">
        <a href="index.html" class="logo"><strong>Pago de Salarios</strong> Banca en Linea</a>
        <nav>
            <a href="#menu">Menu</a>
        </nav>
    </header>
        ...
        <div class="inner">
            ...
            <header>
                ...
                <div>
                    <ul class="actions">
                        <li>
                            <asp:Button ID="Button1" runat="server" Text="Pagar Salarios" Width="988px" OnClick="Button1_Click" />
                        </li>
                    </ul>
                </div>
